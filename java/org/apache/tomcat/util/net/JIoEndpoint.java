...
public class JIoEndpoint extends AbstractEndpoint<Socket> {
    ...
    // --------------------------------------------------- Acceptor Inner Class 监听TCP/IP连接，把连接交由Processor线程处理
    /**
    ...
    protected class Acceptor extends AbstractEndpoint.Acceptor {
        ...
        public void run() {
            ...
            while (running) {
                ...
                try {
                    //if we have reached max connections, wait  达到最大连接等待
    ...
    // ------------------------------------------- SocketProcessor Inner Class     Socket处理线程
    ...
    public void bind() throws Exception {
        ...
        if (serverSocket == null) {
            ...
            //捕捉子类异常IOException->BindException
